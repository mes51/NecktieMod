package com.mes51.minecraft.mods.necktie.world;
 ...
 * Time: 20:55
 */
public class NecktieExplosion extends Explosion
{
    private int field_77289_h = 128;
    private World worldObj = null;
    private Random random = new Random();

    public NecktieExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
    {
        ...
        for (int k2 = 0; k2 < list.size(); ++k2)
        {
            ...
            if (d7 <= 1.0D)
            {
                ...
                if (d8 != 0.0D)
                {
                    ...
                    {
                        entityMap.put((EntityPlayer)entity, this.worldObj.getWorldVec3Pool().getVecFromPool(d0 * d10, d1 * d10, d2 * d10));
                    }
                }
            }
        }
    ...
    public void doExplosionB(boolean par1)
    {
        ...
        if (this.isSmoking)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (l > 0)
                {
                    Block.blocksList[l].onBlockExploded(this.worldObj, i, j, k, this);
                }
            }
        }
